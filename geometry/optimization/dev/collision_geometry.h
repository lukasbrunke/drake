...
class CollisionGeometry {
 public:
  ...
  /** Impose the constraint that the geometry is on a given side of the plane {x
   ...
   For example, to impose the constraint that a sphere on positive side of the
   ...
   of the plane, we consider the following constraints
   aᵀp_AVᵢ + b ≥ 1      (3)
   where Vᵢ is the i'th vertex of the polytope.
   (3) says rational functions are non-negative.
