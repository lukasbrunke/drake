function testCoMWholeBodyKinPlanning
% NOTEST
...
com_kin_planning = CoMWholeBodyKinPlanning(r,t,q_nom_traj,true,[q0;qdot0],kc1{:},kc2{:},kc3,kc4,kc5,pc_knee,lfoot_fc,rfoot_fc);
com_kin_planning = com_kin_planning.setSolverOptions('snopt','print','planning.out');
com_kin_planning = com_kin_planning.addBoundingBoxConstraint(BoundingBoxConstraint(zeros(3,1),zeros(3,1)),com_kin_planning.comdot_idx(:,end));
tic
[xtraj,comtraj,force_traj,F,indo,infeasible_constraint] = com_kin_planning.solve(q_seed_traj);
toc
end