...
RationalForwardKinematicsOld::RationalForwardKinematicsOld(
...
template <typename T>
void RationalForwardKinematicsOld::
...
template <typename T>
void RationalForwardKinematicsOld::CalcLinkPoseWithWeldJoint(
...
void SetPoseToIdentity(
    RationalForwardKinematicsOld::Pose<drake::symbolic::Polynomial>* pose) {
...
void RationalForwardKinematicsOld::
    CalcReshuffledChildLinkPoseAsMultilinearPolynomial(
        ...
        const RationalForwardKinematicsOld::Pose<drake::symbolic::Polynomial>&
            X_AP,
        RationalForwardKinematicsOld::Pose<drake::symbolic::Polynomial>* X_AC)
        const {
  ...
  if (dynamic_cast<const RevoluteMobilizer<double>*>(mobilizer) != nullptr) {
    ...
    throw std::runtime_error(
        "RationalForwardKinematicsOld: prismatic joint is not supported yet.");
    ...
    throw std::runtime_error(
        "RationalForwardKinematicsOld: Can't handle this mobilizer.");
  }
}

std::vector<RationalForwardKinematicsOld::Pose<Polynomial>>
RationalForwardKinematicsOld::CalcLinkPosesAsMultilinearPolynomials(
    const Eigen::Ref<const Eigen::VectorXd>& q_star,
  ...
  std::vector<RationalForwardKinematicsOld::Pose<Polynomial>> poses_poly(
      plant_.num_bodies());
...
RationalForwardKinematicsOld::Pose<drake::symbolic::Polynomial>
RationalForwardKinematicsOld::CalcLinkPoseAsMultilinearPolynomial(
  ...
  std::vector<RationalForwardKinematicsOld::Pose<drake::symbolic::Polynomial>>
      poses(path.size());
...
RationalFunction
RationalForwardKinematicsOld::ConvertMultilinearPolynomialToRationalFunction(
...
std::vector<RationalForwardKinematicsOld::Pose<RationalFunction>>
RationalForwardKinematicsOld::CalcLinkPoses(
    const Eigen::Ref<const Eigen::VectorXd>& q_star,
    BodyIndex expressed_body_index) const {
...
Eigen::VectorXd RationalForwardKinematicsOld::ComputeTValue(
...
VectorX<Expression> RationalForwardKinematicsOld::ComputeTValue(
...
Eigen::VectorXd RationalForwardKinematicsOld::ComputeQValue(
...
VectorX<symbolic::Expression> RationalForwardKinematicsOld::ComputeQValue(
...
VectorX<AutoDiffXd> RationalForwardKinematicsOld::ComputeQValue(
...
VectorX<drake::symbolic::Variable> RationalForwardKinematicsOld::FindTOnPath(
