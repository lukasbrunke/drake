function runAtlasDynamicalWalking(use_mex,use_angular_momentum)
...
sol = load('../../solvers/trajectoryOptimization/dev/atlas_walking_four_steps.mat','xtraj','t_steps','com_steps','comdot_steps','comddot_steps');
...
com = sol.com_steps;
comdot = sol.comdot_steps;
comddot = sol.comddot_steps;
ts = sol.t_steps;
...
l_heel_support = RigidBodySupportState(r,l_foot,{{'heel'}});
r_foot_support = RigidBodySupportState(r,r_foot);
r_toe_support = RigidBodySupportState(r,r_foot,{{'toe'}});
r_heel_support = RigidBodySupportState(r,r_foot,{{'heel'}});

stance_foot = r_foot;
swing_foot = l_foot;
swing_foot_toe_support = RigidBodySupportState(r,[swing_foot stance_foot],{{'toe'},{'heel','toe'}});
swing_foot_flight_support = RigidBodySupportState(r,stance_foot,{{'heel','toe'}});
swing_foot_heel_support = RigidBodySupportState(r,[swing_foot stance_foot],{{'heel'},{'heel','toe'}});
stance_foot_toe_support = RigidBodySupportState(r,[swing_foot stance_foot],{{'heel'},{'toe'}});
swing_foot_full_support = RigidBodySupportState(r,[swing_foot stance_foot],{{'heel','toe'},{'toe'}});

left_phase = [swing_foot_toe_support;swing_foot_toe_support;swing_foot_toe_support;...
  swing_foot_flight_support;swing_foot_flight_support;swing_foot_flight_support;...
  swing_foot_heel_support;swing_foot_flight_support;...
  swing_foot_full_support;swing_foot_full_support];
...
right_phase = [swing_foot_toe_support;swing_foot_toe_support;swing_foot_toe_support;...
  swing_foot_flight_support;swing_foot_flight_support;swing_foot_flight_support;...
  swing_foot_heel_support;swing_foot_flight_support;...
  swing_foot_full_support;swing_foot_full_support];

supports = [left_phase; right_phase(2:end); left_phase(2:end); right_phase(2:end); left_phase(2:end); right_phase(2:end); left_phase(2:end); right_phase(2:end)];
