function runAtlasJumpOffCinderblock2(use_mex,use_angular_momentum)
...
cinderblock_terrain = CinderblockTerrain(cinderblock_dim.*[1;2;1],[cinderblock_pos1(1);0]);
...
options.x0 = xstar.xstar;
options.x0(3) = options.x0(3)+cinderblock_dim(3);
r = Atlas('urdf/atlas_minimal_contact.urdf',options);
r = r.removeCollisionGroupsExcept({'heel','toe'});

r = r.addRobotFromURDF(cinderblock_urdf,cinderblock_pos1(1:3),cinderblock_pos1(4:6));
r = r.addRobotFromURDF(cinderblock_urdf,cinderblock_pos2(1:3),cinderblock_pos2(4:6));
r = compile(r);
...
heel_support = RigidBodySupportState(r,[l_foot,r_foot],{{'heel'},{'heel'}});
...
options.body_accel_input_weights = [2000 2000 10 10 100 100];
...
V_S=warning('off','Drake:DrakeSystem:UnsupportedSampleTime');
