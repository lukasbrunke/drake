...
class QuadrotorTrigGeometry final : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(QuadrotorTrigGeometry);
  ~QuadrotorTrigGeometry() final;
  ...
  static const QuadrotorTrigGeometry* AddToBuilder(
 ...
 private:
  explicit QuadrotorTrigGeometry(geometry::SceneGraph<double>*,
                                 const std::optional<std::string>& name);
