...
void ConstructBallPaddlePlant(
  ...
  *paddle_body_id = paddle_body.index();
  ...
  drake::geometry::AddSoftHydroelasticProperties(100, &paddle_properties);
  paddle_properties.AddProperty(drake::geometry::internal::kMaterialGroup,
                                drake::geometry::internal::kFriction,
                                paddle_friction);
  paddle_properties.AddProperty(drake::geometry::internal::kMaterialGroup,
                                drake::geometry::internal::kElastic, 1E6);
