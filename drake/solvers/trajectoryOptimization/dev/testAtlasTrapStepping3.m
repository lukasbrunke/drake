...
% knee not straight
kny_lb = BoundingBoxConstraint(0.3*ones(2*nT,1),inf(2*nT,1));
...
% final posture should look good
...
final_velocity_bnd = BoundingBoxConstraint(-0.5*ones(nv,1),0.5*ones(nv,1));
...
x_init = sccdfkp_sos.setVGramVarVal(x_init,clean(V,1e-2));
