...
class GlobalIKTest : public ::testing::Test {
 public:
  ...
  void SolveIK(const Eigen::Isometry3d& ee_pose, solvers::SolutionResult global_ik_status_expected) {
    ...
    switch (global_ik_status_expected) {
      ...
      case solvers::SolutionResult::kInfeasibleConstraints:
        ...
        EXPECT_TRUE(global_ik_status == solvers::SolutionResult::kInfeasibleConstraints
        || global_ik_status == solvers::SolutionResult::kInfeasible_Or_Unbounded);
        break;
      default:
